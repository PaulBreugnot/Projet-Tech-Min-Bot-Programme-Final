...
public class SimRadar {
	...
	public SimRadar(ArrayList<Obstacle> obstaclesList, SimRobot titi, Map map) {
	...
	public void updateCaptorDistances() {
		...
		for (int j = 0; j < 5; j++) {
			...
			robotCaptors.get(j).setDistance(
					MinArrayList.minArrayList(measuredDistance) - titi.getRobotSize() + titi.getRadarOffset());
		}
	}
